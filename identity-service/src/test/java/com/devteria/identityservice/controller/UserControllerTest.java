...
public class UserControllerTest {
    ...
    // Co nhiem vu tao ra moc ao service
    ...
    void initData() {
        ...
        // dinh nghia 1 request mac dinh chay truoc @Test
        request = UserCreationRequest.builder()
                ...
                .dob(dob)
                .build();
        // Xac dinh hanh vi trả vè khi response
    ...
    void createUser_validRequest_success() throws Exception {
        ...
        // Dinh nghia hanh vi khi co phuong thuc createUser
